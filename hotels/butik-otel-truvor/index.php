                    ...
                    <table class="object-info-table">
                      <tbody>
                        <tr>
                          ...
                          <td class="val"><a class="no-ul" href="tel:(8162) 55-33-33, +7-952-488-88-88">(8162) 55-33-33,
                              +7-952-488-88-88</a></td>
                        </tr>
                        <tr>
                          <td class="name">Сайт:</td>
                          <td class="val">
                            <a href="http://truvorhotel.com" target="_blank">truvorhotel.com</a><br>
                          </td>
                        </tr>
                        <tr>
                          <td class="name">E-mail:</td>
                          <td class="val"><a class="no-ul"
                              href="mailto:welcome@truvorhotel.com">welcome@truvorhotel.com</a></td>
                        </tr>
                        <tr>
                          <td class="name">Адрес:</td>
                          <td class="val">Великий Новгород, ул. Дворцовая, 2/1</td>
                        </tr>
                        <tr>
                          <td class="name">GPS-координаты:</td>
                          <td class="val">
                            <a href="javascript:void(0)" data-copy="58.520286,31.285869" class="gps-block">
                              <span> 58.520286,31.285869 </span>
                    ...
                    <div class="section-expandable-content">
                      <div class="feedback-form">
                        <div class="feedback-form-content">
                          ...
                          <form id="review-form" class="review-form" action="/hotels/butik-otel-truvor/" method="post"
                            enctype="multipart/form-data">
                            <input type="hidden" name="sessid" id="sessid" value="38ef1dccba42aab18d22c0718834a5b2">
                            <input type="hidden" name="AT3cHUq2jf6I2l08409pRg==" value="UihGTc1qJ+XyJX1tWEXWbg==">
                            ...
                            <input type="hidden" name="z0f6/fiRisLGnKIGeikf7Q==" value="HG92CTvIfOmxSP58F6Nt7w==">
