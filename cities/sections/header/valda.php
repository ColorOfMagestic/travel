<div class="page-header">
                  ...
                  <div class="page-header-content-inner">
                      ...
                      <div class="page-header-top-valign">
                        <div class="page-header-top-valign-cont">
                          ...
                          <div class="page-header-lead">
                            <p>Центр экологического туризма Новгородской области. Удивительный край рек, озёр и лесов.
                            </p>
                          </div>
                        </div>
                      </div>
                    ...
                    <div class="page-header-info">
                      <div class="page-header-info-item">
                        ...
                        <div class="text">Население: <span>14 379 чел </span></div>
                      </div>
                      <div class="page-header-info-item">
        ...
        <div class="header-bottom-bg" style="background-image:url(images/1de407c2cfb4191656cfd04fbeb13db6.jpg);"></div>
