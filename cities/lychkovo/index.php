                ...
                <div class="page-content">
                  <div class="block-ext-parent">
                    ...
                    <div class="block-ext-content">
                      <div>
                        <p>
                          Деревня Лычково находится в Демянском районе на берегу реки Полометь. Этот маленький поселок
                        ...
                        <p>
                          В 1941 году 29 июня началась первая волна эвакуации жителей в Демянский, Валдайский и
                        ...
                        <p>
                          ...
                          из Демянска. 18 июля прибывшие дети стали размещаться в вагонах. В это время на второй путь
                      ...
                      <div>
                        Также деревня ставится своими маршрутами для любителей водного туризма по реке Полометь.
                        Уникальное расположение — на подошве Валдайской возвышенности — открывает для туристов многие
                        дары природы.
                      </div>
                    </div>
                  </div>
